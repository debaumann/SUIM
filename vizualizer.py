...
f, axarr = plt.subplots(10,8, sharex=True,sharey=True, figsize=(8,10))
...
for p in jpgs:
        ...
        if count <= 9:
            axarr[count,0].imshow(img)
                ...
                axarr[count-10,2].imshow(img)
        elif count >= 20 and count<=29 :
                axarr[count -20,4].imshow(img)
        elif count >= 30 and count<=39 :
                axarr[count -30,6].imshow(img)
...
for p in rsbs:
        ...
        if count > 9 and count <= 19:
                ...
                axarr[count-20,5].imshow(img)
        elif count >= 30 and count<=39 :
                axarr[count -30,7].imshow(img)
        elif count >= 40 and count<=49 :
